...
class AllocationInOutPage extends StatefulWidget {
  static const String routeName = '/allocation/in_out';

  @override
  State<StatefulWidget> createState() => _AllocationInOutPageState();
}

// 调拨
class _AllocationInOutPageState extends State<AllocationInOutPage> {
